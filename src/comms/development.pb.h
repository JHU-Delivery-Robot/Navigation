...
#ifndef GOOGLE_PROTOBUF_INCLUDED_development_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_development_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_development_2eproto
...
struct TableStruct_development_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_development_2eproto;
namespace protocols {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::protocols::development::RouteResponse* Arena::CreateMaybeMessage<::protocols::development::RouteResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace protocols {
namespace development {
...
class RouteResponse final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:protocols.development.RouteResponse) */ {
 public:
  inline RouteResponse() : RouteResponse(nullptr) {}
  explicit constexpr RouteResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline void CopyFrom(const RouteResponse& from) {
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "protocols.development.RouteResponse";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:protocols.development.RouteResponse)
 private:
  class _Internal;
  ...
  friend struct ::TableStruct_development_2eproto;
};
// ===================================================================
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_development_2eproto
